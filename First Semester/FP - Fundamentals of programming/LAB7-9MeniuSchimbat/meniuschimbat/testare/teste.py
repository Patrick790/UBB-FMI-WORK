from business.service import tipareste_cheltuieli_dupa_tip, suma_totala_tip, total_cheltuieli_id, \
    sorteaza_lista_cheltuieli_dupa_tip, suma_apartament, lista_apartamente, elimina_cheltuieli_tip, \
    elimina_cheltuieli_mai_mici_decat_suma, lista_cheltuieli_suma_zi
...
from interfata.ui import ui_tipareste_cheltuieli
...
def test():
    ...
    assert suma_totala_tip(lista_cheltuieli, "apa") == 78.36
    ...
    #assert lista_cheltuieli_suma_zi(cheltuiala3, 101, 12, 21) == [cheltuiala3]

    assert elimina_cheltuieli_tip(lista_cheltuieli,"apa") == [cheltuiala2, cheltuiala3, cheltuiala4]
    assert elimina_cheltuieli_mai_mici_decat_suma(lista_cheltuieli, 111) == [cheltuiala3, cheltuiala4]
