...
public class MotorcyclesClientRpcReflectionWorker implements Runnable, IMotorcyclesObserver{
    ...
    private Response handleADD_REGISTRATION(Request request) throws MotorcyclesException, SQLException {
        ...
        // Assuming the request data is a Registration object
    ...
    private Response handleADD_RACE(Request request) throws SQLException, MotorcyclesException {
        ...
        // Assuming the request data is a Race object
    ...
    private Response handleADD_USER(Request request) throws MotorcyclesException {
        ...
        // Assuming the request data is a Participant object
    ...
    private Response handleFIND_AFTER_USERNAME(Request request) throws MotorcyclesException {
        ...
        // Assuming the request data is a String representing the username
    ...
    private Response handleHASH_PASSWORD(Request request) throws MotorcyclesException {
        ...
        // Assuming the request data is a String representing the password
...
private Response handleCOUNT_REGISTRATIONS_FOR_RACE(Request request) throws MotorcyclesException, SQLException {
    ...
    @Override
    public void participantRegistered(Participant participant) throws MotorcyclesException {

    }

    @Override
    public void countRegistrationsForRace(Race race) throws MotorcyclesException {

    }

    @Override
    public void raceAdded(Race race) throws MotorcyclesException {
        System.out.println("Race added: " + race);
        try {
            sendResponse(new Response.Builder().type(ResponseType.ADDED_RACE).data(race).build());
        } catch (IOException e) {
            throw new MotorcyclesException("Error sending race added response", e);
        }
    }
}
