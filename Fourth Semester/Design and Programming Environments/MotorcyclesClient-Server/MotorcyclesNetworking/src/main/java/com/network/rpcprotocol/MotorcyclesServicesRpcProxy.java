...
public class MotorcyclesServicesRpcProxy implements IMotorcyclesServices {
    ...
    private static final List<Observer> observers = Collections.synchronizedList(new ArrayList<>());
    ...
    @Override
    public boolean login(String username, String password, Observer observer) throws MotorcyclesException {
        initializeConnection();
    ...
    private boolean isUpdate(Response response){
        return response.type()== ResponseType.ADDED_RACE || response.type()== ResponseType.REGISTERED_PARTICIPANT ;
    }
