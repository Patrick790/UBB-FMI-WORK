...
public interface IMotorcyclesServices  {
    ...
    boolean login2(String username, String password) throws MotorcyclesException;
    boolean login(String username, String password, IMotorcyclesObserver observer) throws MotorcyclesException;
