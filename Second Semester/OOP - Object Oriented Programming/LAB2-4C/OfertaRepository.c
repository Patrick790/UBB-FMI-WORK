...
OfertaRepo* createRepo()
{
    ...
    r->oferte = createVector(2, (DestroyElementFunctionType) destroyOferta);
    return r;
}
...
{
    //Compara cele 2 oferte dupa destinatie
    //:return: 1 daca dest de la oferta1 > dest de la oferta2, 0 altfel
...
{
    //Compara cele 2 oferte dupa pret
...
void test_undo() {
    Vector* undoList_t = createVector(2, (DestroyElementFunctionType) destroyRepo);
