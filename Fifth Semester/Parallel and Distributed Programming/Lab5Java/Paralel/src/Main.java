...
class ClasamentList {
    ...
    public ClasamentList() {
        head = new Node(null); // Sentinel start
        tail = new Node(null); // Sentinel end
        head.next = tail;
    }
...
public class Main {
    private static final String INPUT_DIR = "C:\\Users\\ardel\\IdeaProjects\\PPD\\Lab5\\Paralel\\src\\data";
